...
export function RemoveProgrammaticallyExample() {
  ...
  return (
    <div>
      <button className={`${sharedStyles.buttonPrimary} ${styles.button}`} onClick={handleAddClick}>
        Add toast
      </button>
      <div className={styles.removeButtons}>
      <button className={`${sharedStyles.buttonSecondary} ${styles.button}`} onClick={handleRemoveClick}>
        Remove last
      </button>
      <button className={`${sharedStyles.buttonSecondary} ${styles.button}`} onClick={handleRemoveAllClick}>
        Remove all
      </button>
      </div>
      <Toaster />
